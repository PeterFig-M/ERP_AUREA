...
import { iniciarSesion } from '../../firebase/auth.service'
    ...
    <div className="flex min-h-screen items-center justify-center bg-aurea-cream px-4">
      <div className="w-full max-w-md animate-fadeInUp rounded-lg border border-aurea-border bg-white p-8 shadow-lg">
        ...
        <form onSubmit={manejarEnvio} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm text-aurea-text">Correo electrónico</label>
            <input
              type="email"
              required
              value={correo}
        ...
        <p className="mt-6 text-center text-sm text-aurea-text">
          ¿No tienes cuenta?{' '}
          <Link to="/registro" className="font-medium text-aurea-goldDark hover:underline">
            Crear cuenta
          </Link>
        </p>
      </div>
